...
inventario = [
    ...
    {"nombre": "Recipientes para almacenar alimentos", "cantidad": 8, "precio": 24000},
...
def validacion():
    # Solicitar el nombre del producto una sola vez
    ...
    while True:
        ...
        try:
            cantidad = int(input("Por favor, ingresa la cantidad del producto: "))
            if cantidad <= 0:
